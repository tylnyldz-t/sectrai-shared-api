...
- Synthetic fixture privacy checks reject TCKN-, Turkish mobile-, Turkish IBAN-, and email-shaped values even when spaces, punctuation, or Unicode format characters obscure them; the same rule covers synthetic audio references and voices, before audit, quota, or artifact persistence.
