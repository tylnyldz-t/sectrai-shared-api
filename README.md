...
- Every governed run snapshots one valid native clock before preflight. Its request/outcome audit timestamps, quota context, synthetic provenance, and review-expiry calculation share that snapshot; an invalid clock fails closed before audit or quota reservation.
