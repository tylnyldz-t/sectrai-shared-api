...
export const ADOS_10_CAMERA_CONTROLS: readonly AdosCameraControl[] = intrinsicObjectFreeze([
  ...
  { id: 'ADOS-04', control: 'NO_MEDIA_OR_BIOMETRICS', enforcement: 'Unknown, hidden, symbol, proxy, accessor, sparse, cyclic, or over-deep input, evidence, D8 caller-context fields, D10 execution-context/provenance-clock values, the D11 runner clock, the D12 governed-run request envelope, the D13 result/provenance control plane, D14/D17 audit append receipts and link witnesses, D15 audit events, D16 durable audit heads, D18 SHA-256 operations, D19 camera result data/provenance values, the D20 governed context snapshot, the D21 governed input snapshot, D22 registry/control-plane values, D23 runner-collaborator control-plane values, D24 late own-data/time intrinsic hooks, and D25 late data-boundary/canonical-JSON hooks—plus media, device identifiers, identity resolution, and biometric inference—are denied.' },
 ...
 * outside the synthetic camera and audit-integrity boundary.
 */
