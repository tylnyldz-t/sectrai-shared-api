...
/** Failed attempts remain reserved: an external adapter may already have charged for them. */
...
/** Missing or malformed limits close the image connector at deployment time. */
