...
/** Per product/workspace append-only SHA-256 chain. Voice payloads are represented
 * by hashes only; neither transcript text nor audio bytes are audit payloads. */
...
/** Test seam only. The application always uses the durable Prisma implementation. */
