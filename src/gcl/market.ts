...
export const ADOS_10_MARKET_CONTROLS: readonly AdosMarketControl[] = Object.freeze([
  ...
  { id: 'ADOS-04', control: 'STRICT_PACKET_INTEGRITY', enforcement: 'Review reconstructs the complete canonical plan; D2 rejects unknown, changed, malformed, or replayed packets, D8/D9 harden local ingress, D10 snapshots context and its clock boundary, D11 requires literal owner approval, D12 snapshots the governed-run envelope, D13 snapshots canonical market input across the runner seam, D14 fixes the connector configuration snapshot, and D3/D4/D5/D6/D7 recheck evidence without a write.' },
  ...
  { id: 'ADOS-08', control: 'BOUNDED_GOVERNANCE', enforcement: 'Preflight, independent cost and quota limits, and the scoped SHA-256 audit chain remain mandatory; D5 reconstructs one caller-supplied segment, D6/D7 only minimize and recheck derived evidence, D8 leaves a malformed append undecided, D9 rejects shaped host results, D10 bounds review context and clock values, D11 rejects non-boolean approval values, D12 snapshots the runner envelope, D13 retains the market preflight snapshot, and D14 fixes the connector configuration snapshot before audit, quota, or run seams.' },
  { id: 'ADOS-09', control: 'NO_MARKET_ACTION', enforcement: 'The packet, review receipt, and D4/D5/D6/D7/D8/D9/D10/D11/D12/D13/D14 evidence permanently report no quote, reservation, booking, publication, handoff, or automatic action.' },
