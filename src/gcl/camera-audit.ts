 ...
 * signature check.
 */
export function validateAuditAppendReceipt(value: unknown): VerifiedAuditAppendReceipt {
 ...
 */
export async function appendVerifiedAuditEvent(auditLog: AuditLog, event: ConnectorAuditEvent, expectedPreviousHash?: string): Promise<VerifiedAuditAppendReceipt> {
...
export class CameraPrismaHashChainAuditLog implements AuditLog {
...
export class CameraInMemoryHashChainAuditLog implements AuditLog {
