...
New proposals use `synthetic-document-review-packet-v14`. Its integrity material adds a fixed `dateArithmeticBoundaryBinding`: `arithmetic: "checked-utc-epoch-milliseconds"`, `overflowAccepted: false`, and `invalidDateAccepted: false`.
