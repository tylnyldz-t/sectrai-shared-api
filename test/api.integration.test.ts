...
test('real Neon CRUD persists across a new Prisma connection and rejects missing product keys', { skip: databaseUrl ? undefined : 'DATABASE_URL is required for real Neon integration tests' }, async () => {
